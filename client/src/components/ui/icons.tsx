...
export const TouchIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const NumberIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    <path d="M5 7 3 5l2-2" />
    <path d="M7 3h1" />
    <path d="M5 17 3 19l2 2" />
    <path d="M7 21h1" />
    <path d="M19 17a6 6 0 0 0 0 4" />
    <path d="M17 21H9" />
    <path d="M17 3c-2.8 0-5 2.2-5 5v11" />
    <path d="M13 9h8" />
  </svg>
);
...
export const GamesIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const BackIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ScoreIcon = ({ size = 24, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
